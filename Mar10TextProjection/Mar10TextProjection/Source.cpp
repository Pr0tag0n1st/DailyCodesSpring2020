...
#define T(str) (y = print(font, x, y, 1, 0.9, 0.3, scroll_y, (str)));
	...
	T("Diamondo wa Kudakenai")
		T("")
		T("My house is in the northeast section")
		T("of Morioh, where all the villas are,")
		T("and I am not married.  I work as an")
		T("employee for the Kame Yu department")
		T("stores, and I get home every day by")
		T("8 PM at the latest.  I don't smoke,")
		T("but I occasionally drink.")
		T("")
		T("I'm in bed by 11 PM, and make sure I")
		T("get 8 hours of sleep, no matter what.")
		T("After having a glass of warm milk and")
		T("doing about twenty minutes of stretches")
		T("before going to bed, I usually have no")
		T("problems sleeping until morning.  Just")
		T("like a baby, I wake up without any")
		T("fatigue or stress in the morning.  I")
		T("was told there were no problems at my")
		T("last check-up.")
		T("")
		T("I'm trying to explain that I'm a person")
		T("who wishes to live a very quiet life.")
		T("I take care not to trouble myself with")
		T("any enemies, like winning and losing, ")
		T("that would cause me to lose sleep at ")
		T("night.  That is how I deal with society,")
		T("and I know that is what brings me happiness.")
		T("Although, if I were to fight I wouldn't")
		T("lose to anyone.")
...
static void draw_intro_text(void)
{
	...
	print(font, 0, 0, 0, 0.9, 1, fade, "My name is Yoshikage Kira...");
	print(font, 0, 0 + fh, 0, 0.9, 1, fade, "I am 33 years old...");
}
...
int main(int argc, char** argv)
{
	...
	font = al_load_font("DejaVuSans.ttf", 40, 0);
	logo = al_load_bitmap("alexlogo.png");
	particle = al_load_bitmap("air_effect.png");
